 ...
 * Generated at: 2015-05-18 05:32:13 UTC
...
public final class top_002dhousing_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("  <title>Top Housing</title>\r\n");
      out.write("\r\n");
...
if(request.getAttribute("success") != null && (Boolean)request.getAttribute("success") == true){
 ...
 if(result == null || !result.isBeforeFirst()){
      ...
      out.write("\t\r\n");
      out.write("\t<div style=\"width:100%; text-align:center;\"><h1>You have not saved any housing!</h1></div> \r\n");
...
if(result.getInt("cable") == 1){ 
 ...
 if(session.getAttribute("curr") == null){ 
      ...
      out.write(" >\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<form id=\"remove-form\" class=\"inline-form\" action=\"/Housing/remove-housing\" method=\"post\">\r\n");
      out.write("\t\t<input type=\"text\" class=\"invisible\" name=\"housingID\" value=");
      out.print( "" + result.getInt("keyid") );
      out.write(" />\r\n");
      out.write("\t\t<input type=\"submit\" class=\"form-button\" value=\"Remove\"/>\r\n");
      out.write("\t\t</form>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
